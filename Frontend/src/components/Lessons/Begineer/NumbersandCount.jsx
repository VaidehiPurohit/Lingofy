  ...
  return (
    <div className="w-full mx-auto p-6 space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() =>
            navigate("/dashboard/lessons/numbers-counting/speaking-practice")
          }
      ...
      <div className="space-y-4">
        {numbersData.map((word, index) => (
          <NumbersItem key={index} {...word} />
        ))}
      </div>
...
export default NumbersandCount